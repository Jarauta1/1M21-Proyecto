document.getElementById("porteros").innerHTML = `<a>Goalkeepers</a>
<ul data-pos="gk">
  <li>
    <div draggable="true" data-player="J.Hart">
      <img draggable="false" src="${localStorage.getItem("porteroFoto1")}"/>
      <p>${localStorage.getItem("porteroNombre1")}</p>
    </div>
  </li>
  <li>
    <div draggable="true" data-player="B.Forster">
      <img draggable="false" src="${localStorage.getItem("porteroFoto2")}"/>
      <p>${localStorage.getItem("porteroNombre2")}</p>
    </div>
  </li>
  <li>
    <div draggable="true" data-player="F.Foster">
      <img draggable="false" src="${localStorage.getItem("porteroFoto3")}"/>
      <p>${localStorage.getItem("porteroNombre3")}</p>
    </div>
  </li>
</ul>`
  //* ===================== é
